...
namespace DbTarpinisAtsiskaitymas
{
    internal class Program
    {
        ...
        private static MainWindow RegisterServices()
        {
            ...
            TransferStudentWindow transferStudentWindow = new TransferStudentWindow(studentService, departmentService, lectureService);
            ...
            AddStudentLectureToExistingDepartmentWindow addLectureToExistingDepartmentWindow = new AddStudentLectureToExistingDepartmentWindow(departmentService, lectureService, transferStudentWindow);
